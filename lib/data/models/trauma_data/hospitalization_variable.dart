class HospitalizationVariable {
    ...
    HospitalizationVariable copyWith({
        ...
        HospitalizationVariable(
            ...
            fechaYHoraDeLaVariable: fechaYHoraDeLaVariable ?? this.fechaYHoraDeLaVariable,
            localizacionDeVariable: localizacionDeVariable ?? this.localizacionDeVariable,
            traumaRegisterRecordId: traumaRegisterRecordId ?? this.traumaRegisterRecordId,
        );

    factory HospitalizationVariable.fromJson(Map<String, dynamic> json) => HospitalizationVariable(
        id: json["id"],
        tipoDeVariable: json["tipo_de_variable"],
        valorDeLaVariable: json["valor_de_la_variable"],
        fechaYHoraDeLaVariable: json["fecha_y_hora_de_la_variable"] == null ? null : DateTime.parse(json["fecha_y_hora_de_la_variable"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "fecha_y_hora_de_la_variable": fechaYHoraDeLaVariable?.toIso8601String(),
