...
class PatientData {
    ...
    String? numDocDeIdentificacion,
      ...
      PatientData(
        ...
        vitalSignGcsQualifier:
            vitalSignGcsQualifier ?? this.vitalSignGcsQualifier,
        hospitalizationVariable:
            hospitalizationVariable ?? this.hospitalizationVariable,
        hospitalizationComplication:
            hospitalizationComplication ?? this.hospitalizationComplication,
        ...
        physicalExamBodyPartInjury:
            physicalExamBodyPartInjury ?? this.physicalExamBodyPartInjury,
  ...
  factory PatientData.fromJson(Map<String, dynamic> json) => PatientData(
        ...
        healthcareRecord: json["healthcare_record"] == null
            ? null
            : HealthcareRecord.fromJson(json["healthcare_record"]),
        injuryRecord: json["injury_record"] == null
            ? null
            : InjuryRecord.fromJson(json["injury_record"]),
        collision: json["collision"] == null
            ? []
            : List<Collision>.from(
                json["collision"]!.map((x) => Collision.fromJson(x))),
        drugAbuse: json["drug_abuse"] == null
            ? []
            : List<DrugAbuse>.from(
                json["drug_abuse"]!.map((x) => DrugAbuse.fromJson(x))),
        vitalSignGcsQualifier: json["vital_sign_gcs_qualifier"] == null
            ? []
            : List<VitalSignGcsQualifier>.from(json["vital_sign_gcs_qualifier"]!
                .map((x) => VitalSignGcsQualifier.fromJson(x))),
        hospitalizationVariable: json["hospitalization_variable"] == null
            ? []
            : List<HospitalizationVariable>.from(
                json["hospitalization_variable"]!
                    .map((x) => HospitalizationVariable.fromJson(x))),
        hospitalizationComplication:
            json["hospitalization_complication"] == null
                ? []
                : List<HospitalizationComplication>.from(
                    json["hospitalization_complication"]!
                        .map((x) => HospitalizationComplication.fromJson(x))),
        traumaRegisterIcd10: json["trauma_register_icd10"] == null
            ? []
            : List<TraumaRegisterIcd10>.from(json["trauma_register_icd10"]!
                .map((x) => TraumaRegisterIcd10.fromJson(x))),
        intensiveCareUnit: json["intensive_care_unit"] == null
            ? []
            : List<IntensiveCareUnit>.from(json["intensive_care_unit"]!
                .map((x) => IntensiveCareUnit.fromJson(x))),
        imaging: json["imaging"] == null
            ? []
            : List<Imaging>.from(
                json["imaging"]!.map((x) => Imaging.fromJson(x))),
        apparentIntentInjury: json["apparent_intent_injury"] == null
            ? []
            : List<ApparentIntentInjury>.from(json["apparent_intent_injury"]!
                .map((x) => ApparentIntentInjury.fromJson(x))),
        burnInjury: json["burn_injury"] == null
            ? []
            : List<BurnInjury>.from(
                json["burn_injury"]!.map((x) => BurnInjury.fromJson(x))),
        firearmInjury: json["firearm_injury"] == null
            ? []
            : List<FirearmInjury>.from(
                json["firearm_injury"]!.map((x) => FirearmInjury.fromJson(x))),
        penetratingInjury: json["penetrating_injury"] == null
            ? []
            : List<PenetratingInjury>.from(json["penetrating_injury"]!
                .map((x) => PenetratingInjury.fromJson(x))),
        poisoningInjury: json["poisoning_injury"] == null
            ? []
            : List<PoisoningInjury>.from(json["poisoning_injury"]!
                .map((x) => PoisoningInjury.fromJson(x))),
        violenceInjury: json["violence_injury"] == null
            ? []
            : List<ViolenceInjury>.from(json["violence_injury"]!
                .map((x) => ViolenceInjury.fromJson(x))),
        device: json["device"] == null
            ? []
            : List<Device>.from(json["device"]!.map((x) => Device.fromJson(x))),
        laboratory: json["laboratory"] == null
            ? []
            : List<Laboratory>.from(
                json["laboratory"]!.map((x) => Laboratory.fromJson(x))),
        physicalExamBodyPartInjury:
            json["physical_exam_body_part_injury"] == null
                ? []
                : List<PhysicalExamBodyPartInjury>.from(
                    json["physical_exam_body_part_injury"]!
                        .map((x) => PhysicalExamBodyPartInjury.fromJson(x))),
        procedure: json["procedure"] == null
            ? []
            : List<Procedure>.from(
                json["procedure"]!.map((x) => Procedure.fromJson(x))),
        prehospitalProcedure: json["prehospital_procedure"] == null
            ? []
            : List<PrehospitalProcedure>.from(json["prehospital_procedure"]!
                .map((x) => PrehospitalProcedure.fromJson(x))),
        transportationMode: json["transportation_mode"] == null
            ? []
            : List<TransportationMode>.from(json["transportation_mode"]!
                .map((x) => TransportationMode.fromJson(x))),
        vitalSign: json["vital_sign"] == null
            ? []
            : List<VitalSign>.from(
                json["vital_sign"]!.map((x) => VitalSign.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "collision": collision == null
            ? []
            : List<dynamic>.from(collision!.map((x) => x.toJson())),
        "drug_abuse": drugAbuse == null
            ? []
            : List<dynamic>.from(drugAbuse!.map((x) => x.toJson())),
        "vital_sign_gcs_qualifier": vitalSignGcsQualifier == null
            ? []
            : List<dynamic>.from(vitalSignGcsQualifier!.map((x) => x.toJson())),
        "hospitalization_variable": hospitalizationVariable == null
            ? []
            : List<dynamic>.from(
                hospitalizationVariable!.map((x) => x.toJson())),
        "hospitalization_complication": hospitalizationComplication == null
            ? []
            : List<dynamic>.from(
                hospitalizationComplication!.map((x) => x.toJson())),
        "trauma_register_icd10": traumaRegisterIcd10 == null
            ? []
            : List<dynamic>.from(traumaRegisterIcd10!.map((x) => x.toJson())),
        "intensive_care_unit": intensiveCareUnit == null
            ? []
            : List<dynamic>.from(intensiveCareUnit!.map((x) => x.toJson())),
        "imaging": imaging == null
            ? []
            : List<dynamic>.from(imaging!.map((x) => x.toJson())),
        "apparent_intent_injury": apparentIntentInjury == null
            ? []
            : List<dynamic>.from(apparentIntentInjury!.map((x) => x.toJson())),
        "burn_injury": burnInjury == null
            ? []
            : List<dynamic>.from(burnInjury!.map((x) => x.toJson())),
        "firearm_injury": firearmInjury == null
            ? []
            : List<dynamic>.from(firearmInjury!.map((x) => x.toJson())),
        "penetrating_injury": penetratingInjury == null
            ? []
            : List<dynamic>.from(penetratingInjury!.map((x) => x.toJson())),
        "poisoning_injury": poisoningInjury == null
            ? []
            : List<dynamic>.from(poisoningInjury!.map((x) => x.toJson())),
        "violence_injury": violenceInjury == null
            ? []
            : List<dynamic>.from(violenceInjury!.map((x) => x.toJson())),
        "device": device == null
            ? []
            : List<dynamic>.from(device!.map((x) => x.toJson())),
        "laboratory": laboratory == null
            ? []
            : List<dynamic>.from(laboratory!.map((x) => x.toJson())),
        "physical_exam_body_part_injury": physicalExamBodyPartInjury == null
            ? []
            : List<dynamic>.from(
                physicalExamBodyPartInjury!.map((x) => x.toJson())),
        "procedure": procedure == null
            ? []
            : List<dynamic>.from(procedure!.map((x) => x.toJson())),
        "prehospital_procedure": prehospitalProcedure == null
            ? []
            : List<dynamic>.from(prehospitalProcedure!.map((x) => x.toJson())),
        "transportation_mode": transportationMode == null
            ? []
            : List<dynamic>.from(transportationMode!.map((x) => x.toJson())),
        "vital_sign": vitalSign == null
            ? []
            : List<dynamic>.from(vitalSign!.map((x) => x.toJson())),
