class Laboratory {
    ...
    Laboratory copyWith({
        ...
        Laboratory(
            id: id ?? this.id,
            resultadoDeLaboratorio: resultadoDeLaboratorio ?? this.resultadoDeLaboratorio,
            fechaYHoraDeLaboratorio: fechaYHoraDeLaboratorio ?? this.fechaYHoraDeLaboratorio,
            nombreDelLaboratorio: nombreDelLaboratorio ?? this.nombreDelLaboratorio,
            nombreDeLaUnidadDeLaboratorio: nombreDeLaUnidadDeLaboratorio ?? this.nombreDeLaUnidadDeLaboratorio,
    ...
    Map<String, dynamic> toJson() => {
        ...
        "fecha_y_hora_de_laboratorio": fechaYHoraDeLaboratorio?.toIso8601String(),
