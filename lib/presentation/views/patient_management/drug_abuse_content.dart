...
class DrugAbuseContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExpandableTitleWidget(
      ...
      index: 4,
      expandedWidget: traumaDataProvider.patientData!.drugAbuse == null ||
              traumaDataProvider.patientData!.drugAbuse!.isEmpty
          ? noDataWidget
          : SizedBox(
              ...
              child: Wrap(
                runSpacing: 10,
                spacing: 10,
                children: traumaDataProvider.patientData!.drugAbuse!
                    .map(
