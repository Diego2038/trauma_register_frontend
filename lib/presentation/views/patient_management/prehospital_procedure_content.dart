...
class PrehospitalProcedureContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExpandableTitleWidget(
      ...
      index: 21,
      expandedWidget: traumaDataProvider.patientData!.prehospitalProcedure ==
                  null ||
              traumaDataProvider.patientData!.prehospitalProcedure!.isEmpty
          ? noDataWidget
          : SizedBox(
              ...
              child: Wrap(
                runSpacing: 10,
                spacing: 10,
                children: traumaDataProvider.patientData!.prehospitalProcedure!
                    .map(
